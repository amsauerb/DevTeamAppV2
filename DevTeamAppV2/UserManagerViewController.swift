...
class UserManagerViewController
...
//        container.layer.masksToBounds =  true
    ...
    func showMailComposer() {
        ...
        let delimiter = "@"
        let emailTokens = emailField.text!.components(separatedBy: delimiter)
...
extension UserManagerViewController: MFMailComposeViewControllerDelegate {
